          ...
          {tabPanel?.map((e, i) => {
            return (
              <div className=" w-full flex flex-col md:flex-row">
                <div className="md:w-[60%] md:px-20 md:pl-52 px-10 space-y-5 flex flex-col gap-5 py-10">
                  <h1 className="heading2">{e?.heading} <span className="text-5xl">(RERA # BPL - 1136)</span></h1>
                  <h1 className="lg:text-4xl md:text-3xl text-2xl">{e?.para}</h1>
                  <h1 className="lg:text-4xl md:text-3xl text-2xl">{e?.subHeading}</h1>
                  <div className="flex flex-col md:flex-row  w-full gap-10">
                    <div className="w-full md:w-1/2 h-96 rounded-2xl bg-red-950">
                      <iframe
                    ...
                    <div className="w-full md:w-1/2 flex flex-col gap-4">
                      ...
                      <ul className="space-y-3">
                        <li className="text-3xl font-semibold ">1. Nestled in a forested region.</li>
                        <li className="text-3xl font-semibold ">2. Located 1.8 km from the Bhopal-Indore express highway.</li>
                        <li className="text-3xl font-semibold ">3. Close to the six-lane Western Highway.</li>
                        <li className="text-3xl font-semibold ">4. Accessible via a four-lane road.
                        </li>
                        <li className="text-3xl font-semibold ">5. Close to Ratapani Sanctuary </li>
                        <li className="text-3xl font-semibold ">6. With promising returns projected to upto 3x in the coming years.</li>
                      </ul>
                    </div>
                  </div>
                </div>
                <div className="md:w-[40%] h-[80vh] hidden md:block ">
